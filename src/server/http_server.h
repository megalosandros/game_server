...
//  Практически аналогичный пример можно изучить в документации по Boost.Beast:
//  https://www.boost.org/doc/libs/1_78_0/libs/beast/example/http/server/async/http_server_async.cpp
//
...
//
// Код класса списан из урока
// Операции чтения/записи выполняются асинхронно
// Методы Read/Write только инициируют начало операции, а завершение
// операции и разбор результата выполняется в OnRead/OnWrite
//
class SessionBase {
public:
